    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title"><b>ACCS Iganga</b></h4>
            </div>
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="accsiadd.php" enctype="multipart/form-data">
                <div class="form-group">
                    <label for="cno" class="col-sm-3 control-label">Center No.</label>
...
<div class="modal fade" id="edit">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="accsiedit.php">
                <input type="hidden" class="id" name="id">
                 <div class="form-group">
                    <label for="cno" class="col-sm-3 control-label">Center No.</label>

                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="ecno" name="cno" required>
                    </div>
                </div>
                  <div class="form-group">
                    <label for="fullname" class="col-sm-3 control-label">Full Name</label>
...
<div class="modal fade" id="delete">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="accsidelete.php">
                <input type="hidden" class="id" name="id">
...
<div class="modal fade" id="edit_photo">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="accsiphoto.php" enctype="multipart/form-data">
                <input type="hidden" class="id" name="id">
                <div class="form-group">
                    <label for="photo" class="col-sm-3 control-label">Photo</label>
