    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title"><b>Agape Children's village</b></h4>
            </div>
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="acvstaffadd.php" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="addressfrom" class="col-sm-3 control-label">Address From</label>
...
<div class="modal fade" id="edit">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="acvedit.php">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <select name="house" id="ehouse" class="form-control">
                        <option value="H.1" >H.1</option>
                        <option value="H.2" >H.2</option>
                        <option value="H.7" >H.7</option>
                        <option value="H.8" >H.8</option>
...
<div class="modal fade" id="delete">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="acvdelete.php">
                <input type="hidden" class="id" name="id">
...
<div class="modal fade" id="edit_photo">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="acvphoto.php" enctype="multipart/form-data">
                <input type="hidden" class="id" name="id">
                <div class="form-group">
                    <label for="photo" class="col-sm-3 control-label">Photo</label>
