...
<div class="wrapper">
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header with-border">
              ...
              <a href="budget1.php" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-print"></i>Print view</a>
              ...
              <a href="womengallery.php" class="btn btn-success btn-sm btn-flat">Gallery</a>
            
             <br/><br/>
             <h3><b>Youth Camps</b></h3>
            </div>
            <div class="box-body">
              <table id="example1" class="table table-bordered">
                ...
                <tbody>
                  <?php
                       ...
                       $sql=$conn->query("SELECT SUM(qty*unicost) AS sum FROM `budget1`  ") or die("Failed to fetch row!");
  ...
  <?php include 'includes/womenmodal.php'; ?>
  <?php include 'includes/womenmodal1.php'; ?>
