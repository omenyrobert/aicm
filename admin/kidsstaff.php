...
<br/>
                    ...
                    while($row = $query->fetch_assoc()){
                      ...
                      echo "
                        ...
                        <td>".$row['dob']."</td>
                          ...
                          <td>
                           <a href='kidsstaffview.php?id=$row[id]' class='btn btn-info'><i class='fa fa-user-edit'></i>View</a>
  ...
  <?php include 'includes/kidsstaffmodal.php'; ?>
</div>
