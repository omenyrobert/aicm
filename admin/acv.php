...
<div class="wrapper">
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header with-border">
              ...
              <br/><br/>
              <h4>Group By</h4>
              <a href="acvage.php" class="btn btn-primary"><h4>Age</h4></a>
              <a href="acvclass.php" class="btn btn-primary"><h4>Class</h4></a>
              <a href="acvhouse.php" class="btn btn-primary"><h4>House</h4></a>
              <a href="acvgender.php" class="btn btn-primary"><h4>Gender</h4></a>
              <a href="acvfamily.php" class="btn btn-primary"><h4>Family</h4></a>
              <a href="acvstaff.php" class="btn btn-success"><h4>Staff</h4></a>
              <a href='acvgallery.php' class='btn btn-warning'>Gallery</a>
            </div>
            <div class="box-body">
  ...
  <?php include 'includes/acvmodal.php'; ?>
</div>
