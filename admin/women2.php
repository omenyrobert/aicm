        ...
        <div class="col-xs-12">
         ...
         <div class="box">
            <div class="box-header with-border">
              ...
              <a href="budget2.php" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-print"></i>Print view</a>
...
$sql=$conn->query("SELECT SUM(qty*unicost) AS sum FROM `budget2`  ") or die("Failed to fetch row!");
