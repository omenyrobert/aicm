...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="accsi.php"><i class="fa fa-dashboard"></i>Dashboard</a></li>
        <li class="active">ACCS Iganga Gallery</li>
  ...
  <?php include 'includes/accsigmodal.php'; ?>
</div>
