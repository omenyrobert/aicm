...
<body class="container">
  ...
  <!-- Content Wrapper. Contains page content -->
    ...
    <section class="content-header">
      ...
      <a href="acv.php">Back</a>
      <ol class="breadcrumb">
        <li><a href="acv.php"><i class="fa fa-dashboard"></i>Dashboard</a></li>
    ...
    <!-- Main content -->
     ...
     <h1><b>
        Agape Children's Village Child's Profile
...
<br/><br/>
                ...
                <div class="col-xs-6">
                    ...
                    <p>House: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <?php echo $house;?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;School: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <?php echo $school;?></p>
                    <hr/>
