...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1><b>
       Agape Child community Sponsorships Bukerere
      </b>
      </h1>
      <ol class="breadcrumb">
        <li><a href="home.php"><i class="fa fa-dashboard"></i>Dashboard</a></li>
        <li class="active">Agape Child community Sponsorships Bukerere</li>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header with-border">
              ...
              <a href="accsbclass.php" class="btn btn-primary"><h4>Class</h4></a>
              <a href="accsbgender.php" class="btn btn-primary"><h4>Gender</h4></a>
              <a href="accsbstaff.php" class="btn btn-success"><h4>Staff</h4></a>
              <a href="accsbgallery.php" class="btn btn-warning"><h4>Gallery</h4></a>
            </div>
            <div class="box-body">
                    ...
                    while($row = $query->fetch_assoc()){
                      ...
                      echo "
                        ...
                        <td>".$row['dob']."</td>
                          ...
                          <td>
                           <a href='accsbprofile.php?id=$row[id]' class='btn btn-info'><i class='fa fa-user-edit'></i>View</a>
  ...
  <?php include 'includes/accsbmodal.php'; ?>
</div>
