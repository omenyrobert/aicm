...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1><b>
        Agape Institute & University Scholarships Gallery
      </b>
      </h1>
      <ol class="breadcrumb">
        <li><a href="home.php"><i class="fa fa-dashboard"></i>Dashboard</a></li>
        <li class="active"> Agape Institute & University Scholarships Gallery</li>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered">
                  ...
                  <?php
                    ...
                    $sql = "SELECT * FROM universitygallery";
  ...
  <?php include 'includes/universitygmodal.php'; ?>
</div>
