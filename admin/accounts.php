...
<div class="wrapper">
                    ...
                    while($row = $query->fetch_assoc()){
                      ...
                      ?>
                        ...
                        <td><?php echo $row['email']; ?></td>
                          ...
                          <td>
                          <a href="deleteacc.php?del=<?php echo $row['id']; ?>" class="btn btn-danger" onclick="return confirm('Are you sure to delete this record?')"><i class="fa fa-trash-alt"></i>Del</a>
                          </td>
                        </tr>
                    <?php 
  ...
  <?php include 'includes/accountsmodal.php'; ?>
</div>
