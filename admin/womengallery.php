...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Women of worth</li>
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-body">
              <center>
                <h1>Women Conference gallery</h1>
              </center>              
              <table id="example1" class="table table-bordered">
                  ...
                  <?php
                    ...
                    $sql = "SELECT * FROM womengallery where type='women'";
 ...
 <div class="box-body">
              <center>
                <h1>Youth Conference gallery</h1>
              </center>              
              <table id="example1" class="table table-bordered">
                  ...
                  <?php
                    ...
                    $sql = "SELECT * FROM womengallery where type='youths'";
                    $query = $conn->query($sql);
                    while($row = $query->fetch_assoc()){
 ...
 <div class="box-body">
              <center>
                <h1>Pastors' Conference gallery</h1>
              </center>              
              <table id="example1" class="table table-bordered">
                  ...
                  <?php
                    ...
                    $sql = "SELECT * FROM womengallery where type='pastors'";
                    $query = $conn->query($sql);
                    while($row = $query->fetch_assoc()){
  ...
  <?php include 'includes/womengmodal.php'; ?>
</div>
