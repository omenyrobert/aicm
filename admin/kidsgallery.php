...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1 style="font-size: 40px;" ><b>
        Agape Kids Choir's Gallery
      </b>
      </h1>
      <ol class="breadcrumb">
        <li><a href="kids.php"><i class="fa fa-dashboard"></i>Back</a></li>
        <li class="active">Agape Kids Choir's Gallery</li>
  ...
  <?php include 'includes/kidsgmodal.php'; ?>
</div>
