  ...
  <div class="container">
    ...
    <section class="content-header">
      <h1 style="font-size: 34px;" ><b>
        ACCS Bukerere Staff Members 
      </b>
      </h1>
      <ol class="breadcrumb">
        <li><a href="acv.php"><i class="fa fa-dashboard"></i>Back</a></li>
        <li class="active"> ACCS Bukerere</li>
...
<br/>
                    ...
                    while($row = $query->fetch_assoc()){
                      ...
                      echo "
                        ...
                        <td>".$row['dob']."</td>
                          ...
                          <td>
                           <a href='accsbstaffview.php?id=$row[id]' class='btn btn-info'><i class='fa fa-user-edit'></i>View</a>
  ...
  <?php include 'includes/accsbstaffmodal.php'; ?>
</div>
